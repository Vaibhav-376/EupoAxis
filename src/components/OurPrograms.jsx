        ...
        <section className='py-4'>
            ...
            <div className='flex flex-wrap gap-10 mt-10 justify-center'>
                {ourPrograms.map((programs) => (
                    <div
                        key={programs.id}
                        className='bg-white p-4 rounded-lg shadow-lg max-w-xs w-full text-center transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl focus:outline-none hover:bg-blue-50 hover:translate-y-1'
                    >
                        <img
                            src={programs.programImage}
                            alt=""
                            className='w-96 h-56 rounded-2xl mb-2 transition-transform duration-300 ease-in-out transform hover:scale-105'
                        />
                        <h1 className='text-2xl font-bold text-blue-700 mb-2 transition-all duration-300 ease-in-out hover:text-blue-500'>
